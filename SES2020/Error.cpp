...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY_NODEF(108), ERROR_ENTRY_NODEF(109),	ERROR_ENTRY_NODEF10(110), ERROR_ENTRY_NODEF10(120),
		...
		ERROR_ENTRY(304, "Ошибка в условии цикла"),
		ERROR_ENTRY_NODEF(305),	ERROR_ENTRY_NODEF(306),	ERROR_ENTRY_NODEF(307),
		ERROR_ENTRY_NODEF(308),	ERROR_ENTRY_NODEF(309),	ERROR_ENTRY_NODEF10(310), ERROR_ENTRY_NODEF10(320), ERROR_ENTRY_NODEF10(330),
		...
		ERROR_ENTRY(405, "Переопределение переменной"),
		ERROR_ENTRY(406, "Слишком большое количество функций"),
